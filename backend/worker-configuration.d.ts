/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: 531f10c51d98bbb221d0c59de16c7694)
// Runtime types generated with workerd@1.20251109.0 2025-11-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "PlanPalDO" | "Chat";
	}
	interface Env {
		ENVIRONMENT: "development";
		MODEL: "@cf/meta/llama-3.1-8b-instruct";
		PLANPAL_DO: DurableObjectNamespace<import("./src/worker").PlanPalDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "MODEL">> {}
}
